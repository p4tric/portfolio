...
const About = () => {
  ...
  const skills = ['JavaScript (ES6+)', 'React', 'Python', 'Flutter', 'Node.js', 'Next.js'];
    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hi! Patrick here, and I enjoy learning and building stuff for the internet. My
              interest in web development started back in 2011 when I decided to try using web
              inspector and modifying web content — drives me to go deeper about HTML &amp; CSS!
            </p>
